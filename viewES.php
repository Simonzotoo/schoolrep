...
<head>
	...
	<title>Admin- Excellent Students</title>
		...
		<div class="main-panel">
			<div class="content">
				<div class="container-fluid">
					<h4 class="page-title">View Excellent Students Page</h4>
					<div class="row">
						<div class="col-md-6">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Excellent Students Table </div>
								</div>
...
$query =   "SELECT DISTINCT  Students.*, Grades.grade ".
"FROM Students, Grades ".
"WHERE Students.id = Grades.student_id AND Grades.grade='A+' ";
